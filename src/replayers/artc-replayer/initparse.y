...
entry: DIRTYPE DELIM PATH NEWLINE {
	$$.path = $3;
	$$.type = $1;
	$$.next = NULL;
}
| FILETYPE DELIM UINT DELIM PATH DELIM UINT NEWLINE {
...
| FILETYPE DELIM PATH DELIM UINT NEWLINE {
	$$.path = $3;
	$$.type = $1;
	$$.size = $5;
}
| FILETYPE DELIM RSRCINUM DELIM PATH DELIM UINT NEWLINE {
	$$.type = FT_RSRCFORK;
	xfree($5);
}
| LINKTYPE DELIM PATH DELIM PATH NEWLINE {
	$$.path = $3;
	$$.type = $1;
	$$.target = $5;
}
 ...
 * path.
 */
| LINKTYPE DELIM PATH DELIM UINT NEWLINE {
	$$.path = $3;
	$$.type = $1;
