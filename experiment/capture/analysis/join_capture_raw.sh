...
# outdir/machine/trace_type/vm_type/$sample.$random.$workload.$nthreasd.$delay.$nops.$blksize.$sample.$nbackground.$mode.load
# e.g outdir/lambaru/stap/small/9.8804569.seqw.4.10000.1000.4096.9.4.same-disk.load.err
...
do
    ...
    trace_type=$(basename $(dirname $(dirname $file)))
